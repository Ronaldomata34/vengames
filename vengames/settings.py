"""
Django settings for vengames project.
...
# get secret information from external folder
secret_information = {}
...
SECRET_KEY = secret_information['SECRET_KEY']
...
WSGI_APPLICATION = 'vengames.wsgi.application'
